// services/dispatch-service/interfaces/grpc/dispatch_handler.go
package grpc
...
func NewDispatchHandler(useCases *usecases.DispatchUseCases) *DispatchHandler {
	return &DispatchHandler{useCases: useCases}
}

func (h *DispatchHandler) MatchRide(ctx context.Context, req *dispatchv1.MatchRideRequest) (*dispatchv1.MatchRideResponse, error) {
...
func (h *DispatchHandler) GetMatches(ctx context.Context, req *dispatchv1.GetMatchesRequest) (*dispatchv1.GetMatchesResponse, error) {
	if req == nil || req.DispatchRequestId == "" {
		return nil, status.Error(codes.InvalidArgument, "dispatch request ID is required")
	}

	input := &usecases.GetMatchesInput{DispatchRequestID: req.DispatchRequestId}

	output, err := h.useCases.GetMatches(ctx, input)
	if err != nil {
...
func (h *DispatchHandler) AcceptMatch(ctx context.Context, req *dispatchv1.AcceptMatchRequest) (*emptypb.Empty, error) {
	...
	err := h.useCases.AcceptMatch(ctx, &usecases.AcceptMatchInput{
...
func (h *DispatchHandler) RejectMatch(ctx context.Context, req *dispatchv1.RejectMatchRequest) (*emptypb.Empty, error) {
	if req == nil || req.DispatchRequestId == "" {
		return nil, status.Error(codes.InvalidArgument, "dispatch request ID is required")
	}

	err := h.useCases.RejectMatch(ctx, &usecases.RejectMatchInput{
		DispatchRequestID: req.DispatchRequestId,
		Reason:            req.Reason,
...
func (h *DispatchHandler) CancelDispatch(ctx context.Context, req *dispatchv1.CancelDispatchRequest) (*emptypb.Empty, error) {
	if req == nil || req.DispatchRequestId == "" {
		return nil, status.Error(codes.InvalidArgument, "dispatch request ID is required")
	}

	err := h.useCases.CancelDispatch(ctx, &usecases.CancelDispatchInput{
		DispatchRequestID: req.DispatchRequestId,
	})
	if err != nil {
...
func (h *DispatchHandler) GetDispatchStats(ctx context.Context, req *dispatchv1.GetStatsRequest) (*dispatchv1.GetStatsResponse, error) {
